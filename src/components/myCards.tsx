      ...
      <Card key={post.id} className="flex flex-col bg-[#eeeeee]">
        ...
        <CardContent className="flex-1 p-6">
          <div className="flex items-center gap-4 mb-2">
            <span className="text-xs font-bold text-[#E97451]">{post.category}</span>
            <span className="text-xs text-gray-500">{post.date}</span>
          </div>
          <h3 className="text-xl font-bold mb-2 text-[#ff924f] line-clamp-2">{post.heading}</h3>
          <p className="text-[#E97451] line-clamp-3">
